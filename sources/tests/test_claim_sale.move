module movegpt::test_claim_sale {
    ...
    fun test_e2e(recipient_ido: &signer, recipient_ido2: &signer, recipient_private: &signer, recipient_private2: &signer, operator: &signer, deployer: &signer) {
        ...
        let ido_spore_amount = vector[300,400];
        let ido_cell_amount = vector[500,600];
        ...
        claim_sale::add_ido_claimers_spore(operator, vector[recipient_ido_address, recipient_ido2_address], ido_spore_amount);
        claim_sale::add_ido_claimers_cell(operator, vector[recipient_ido_address, recipient_ido2_address], ido_cell_amount);
        ...
        let nfts_ido = claim_sale::claim_ido(recipient_ido, 0);
        let nfts_ido2 = claim_sale::claim_ido(recipient_ido2, 0);
        ...
        let nfts_ido = claim_sale::claim_ido(recipient_ido, 1);
        let nfts_ido2 = claim_sale::claim_ido(recipient_ido2, 1);
        assert!(vector::length(&nfts_ido) == 3, 1);
        assert!(vector::length(&nfts_ido2) == 3, 1);
        assert!(movegpt_token::balance(recipient_ido_address) == 300 / 4 + 100 / 4, 1);
        assert!(movegpt_token::balance(recipient_ido2_address) == 400 / 4 + 200 / 4, 1);
        let nft_ido_9m = vector::pop_back(&mut nfts_ido);
        let nft_ido_6m = vector::pop_back(&mut nfts_ido);
        let nft_ido_3m = vector::pop_back(&mut nfts_ido);
        let nft2_ido_9m = vector::pop_back(&mut nfts_ido2);
        let nft2_ido_6m = vector::pop_back(&mut nfts_ido2);
        let nft2_ido_3m = vector::pop_back(&mut nfts_ido2);
        assert!(voting_escrow::get_ve_token_lock_amount(nft_ido_3m) == 300 / 4, 1);
        assert!(voting_escrow::get_ve_token_lock_amount(nft_ido_6m) == 300 / 4, 1);
        assert!(voting_escrow::get_ve_token_lock_amount(nft_ido_9m) == 300 / 4, 1);
        assert!(voting_escrow::get_ve_token_lock_amount(nft2_ido_3m) == 400 / 4, 1);
        assert!(voting_escrow::get_ve_token_lock_amount(nft2_ido_6m) == 400 / 4, 1);
        assert!(voting_escrow::get_ve_token_lock_amount(nft2_ido_9m) == 400 / 4, 1);
        assert!(voting_escrow::get_ve_token_lock_end_epoch(nft_ido_3m) - epoch::now() == 13, 1);
        assert!(voting_escrow::get_ve_token_lock_end_epoch(nft_ido_6m) - epoch::now() == 26, 1);
        assert!(voting_escrow::get_ve_token_lock_end_epoch(nft2_ido_9m) - epoch::now() == 39, 1);
        assert!(voting_escrow::get_ve_token_lock_end_epoch(nft2_ido_3m) - epoch::now() == 13, 1);
        ...
        let nfts_ido = claim_sale::claim_ido(recipient_ido, 2);
        let nfts_ido2 = claim_sale::claim_ido(recipient_ido2, 2);
        assert!(vector::length(&nfts_ido) == 3, 1);
        assert!(vector::length(&nfts_ido2) == 3, 1);
        assert!(movegpt_token::balance(recipient_ido_address) == 500 / 4 + 300 / 4 + 100 / 4, 1);
        assert!(movegpt_token::balance(recipient_ido2_address) == 600 / 4 + 400 / 4 + 200 / 4, 1);
        let nft_ido_9m = vector::pop_back(&mut nfts_ido);
        let nft_ido_6m = vector::pop_back(&mut nfts_ido);
        let nft_ido_3m = vector::pop_back(&mut nfts_ido);
        let nft2_ido_9m = vector::pop_back(&mut nfts_ido2);
        let nft2_ido_6m = vector::pop_back(&mut nfts_ido2);
        let nft2_ido_3m = vector::pop_back(&mut nfts_ido2);
        assert!(voting_escrow::get_ve_token_lock_amount(nft_ido_3m) == 500 / 4, 1);
        assert!(voting_escrow::get_ve_token_lock_amount(nft_ido_6m) == 500 / 4, 1);
        assert!(voting_escrow::get_ve_token_lock_amount(nft_ido_9m) == 500 / 4, 1);
        assert!(voting_escrow::get_ve_token_lock_amount(nft2_ido_3m) == 600 / 4, 1);
        assert!(voting_escrow::get_ve_token_lock_amount(nft2_ido_6m) == 600 / 4, 1);
        assert!(voting_escrow::get_ve_token_lock_amount(nft2_ido_9m) == 600 / 4, 1);
        assert!(voting_escrow::get_ve_token_lock_end_epoch(nft_ido_3m) - epoch::now() == 13, 1);
        assert!(voting_escrow::get_ve_token_lock_end_epoch(nft_ido_6m) - epoch::now() == 26, 1);
        assert!(voting_escrow::get_ve_token_lock_end_epoch(nft2_ido_9m) - epoch::now() == 39, 1);
        assert!(voting_escrow::get_ve_token_lock_end_epoch(nft2_ido_3m) - epoch::now() == 13, 1);
